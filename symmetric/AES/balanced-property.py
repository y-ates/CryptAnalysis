...
def main():
    ...
    print "[#] Verifying balanced property for AES...", "\r\n"
    ...
    if res == 0:
        print "[+] Successfull mounted POC of balanced property for AES."
        print "    Sum of all 256 lambda states:", res
    else:
        print "[-] Could not verify balanced property - something went wrong!"
        print "    Sum of all 256 lambda states:", res
